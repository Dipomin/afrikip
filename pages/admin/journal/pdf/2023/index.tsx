...
import TableWrapperUser from "../../../../../components/admin-journal/table/TableWrapperUser_2023";
    ...
    <div className="border-t">
      <section className="container space-y-5">
        ...
        <h2 className="text-2xl font-bold text-center pt-10">
          Archives 2023 des parutions de l&apos;Intelligent d&apos;Abidjan -
          Version numérique
        </h2>
        <div>
...
export const getServerSideProps: GetServerSideProps = async () => {
  const docsResults = await getDocs(collection(db, "archives", "pdf", "2023"));
