...
const JournalArchive: React.FC<JournalsPageProps> = ({ journals }) => {
  ...
  const handleJournalClick = (journal: JournalData) => {
    // Rediriger vers la page de détail au lieu d'ouvrir le modal
          ...
          <div className="max-w-7xl mx-auto px-6 py-16">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-black">
                Boutique | L&apos;Intelligent d&apos;Abidjan
              </h1>
            </div>
            <p className="text-xl text-blue-100 max-w-3xl">
              Achetez les éditions numériques du quotidien L'Intelligent
              d'Abidjan ou{" "}
              <a
                href="/abonnement"
              ...
              pour un accès illimité à tous les numéros.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <button
                onClick={() => router.push("/dashboard")}
                className="flex items-center gap-2 px-6 py-3 bg-white/20 backdrop-blur-sm text-white rounded-lg hover:bg-white/30 transition-all border border-white/30 font-semibold"
              >
