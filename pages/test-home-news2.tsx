  ...
  const testArticles = [
    {
      ...
      excerpt:
        "Comment l'intelligence artificielle transforme la façon dont nous développons des applications web modernes et interactives.",
    ...
    },
    {
      ...
      excerpt:
        "Tour d'horizon des tendances du marché des cryptomonnaies et des innovations blockchain qui façonnent l'économie numérique.",
    ...
    },
    {
      ...
      excerpt:
        "Découvrez les technologies vertes et les initiatives durables qui contribuent à lutter contre le réchauffement climatique.",
          ...
          <div className="py-8">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Découvrez le composant HomeNews2 entièrement refactorisé avec un
                design moderne, des animations fluides, des métadonnées
                enrichies et une accessibilité complète.
              </p>
            </div>
